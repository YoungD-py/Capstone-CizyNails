...
<head>
    ...
    <title>Register - Cizy Nails</title>
    ...
    <nav class="bg-white shadow-sm">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <a href="{{ route('login') }}" class="text-gray-600 hover:text-gray-900">Already have an account? Login</a>
            </div>
        </div>
    </nav>
        ...
        <div class="max-w-md w-full bg-white rounded-lg shadow-md p-8">
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" id="name" name="name" value="{{ old('name') }}" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-transparent" placeholder="John Doe">
                    @error('name')
                ...
                <div>
                    ...
                    <input type="tel" id="phone" name="phone" value="{{ old('phone') }}" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-transparent" placeholder="0812-1234-5678">
                    @error('phone')
                        <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <p class="text-center text-gray-600 text-sm mt-6">
                Already have an account? <a href="{{ route('login') }}" class="text-pink-600 hover:text-pink-700 font-medium">Login here</a>
            </p>
        </div>
    </div>
</body>
